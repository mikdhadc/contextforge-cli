...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, and any other forum used by the project. It also applies when an individual is officially representing the project in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by opening a [GitHub issue](../../issues) marked **[conduct]** or by contacting the maintainers directly via the contact details in [SECURITY.md](SECURITY.md).
...
*Consequence:* A temporary ban from any sort of interaction or public communication with the project for a specified period.
